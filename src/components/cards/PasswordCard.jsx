    ...
    <form className="card-form">
      ...
      <div className="password-card-footer-container">
        <p className="note">
          ...
          <a className="link">Terms of Service</a> and{" "}
          <a className="link"> Privacy Policy</a>, including
          <a className="link"> Cookie Use </a>. X may use your contact
          ...
          <a className="link"> Learn more</a>. Others will be able to find you
